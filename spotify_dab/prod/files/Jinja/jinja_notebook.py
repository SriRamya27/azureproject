...
# MAGIC %md
# MAGIC ### Metadata Driven pipelines using Jinja

# COMMAND ----------

#goal is to dynamically apply joins between fact table, dimuser and dimartist
parameters = [
    {
...
# MAGIC %md
# MAGIC ### parameterized dynamic query using jinja

# COMMAND ----------

# since we don't want comma for the last col, we need to create an if condition
query_text = """
